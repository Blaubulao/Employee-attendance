  ...
  <div class="container">
    ...
    <el-dialog v-model="editDialogVisible" title="编辑记录">
      <el-form :model="editForm" label-width="90px">
        ...
        <el-form-item label="上班时间">
          <el-time-picker v-model="editForm.startTime" format="HH:mm" value-format="HH:mm"
            placeholder="可留空表示休息" style="width:200px;" />
        </el-form-item>
        <el-form-item label="下班时间">
          <el-time-picker v-model="editForm.endTime" format="HH:mm" value-format="HH:mm"
            placeholder="可留空表示休息" style="width:200px;" />
        </el-form-item>
        <el-form-item label="备注">
...
.card-form,.card-filter,.card-table{padding:10px;}
.table-wrapper{overflow-x:auto;}
.filter-bar{display:flex;gap:12px;align-items:center;margin-bottom:10px;flex-wrap:wrap;}
</style>
